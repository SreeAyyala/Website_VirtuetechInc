  ...
  render() {
    return (<Fragment>
      ...
      <div className="sub_container">
        <div className="row">
          <div className="col">
            <img src="./icons_2_png/cloud-computing.png" alt="database" width="200px" height="200px"></img>
          ...
          <div className="col">
            <img src="./icons_2_png/layers.png" alt="database" width="200px" height="200px"></img>
        ...
        <div className="row p-4">
          <div className="col">
            <img src="./icons_2_png/timeline.png" alt="database" width="200px" height="200px"></img>
          ...
          <div className="col">
            <img src="./icons_2_png/database.png" alt="database" width="200px" height="200px"></img>
